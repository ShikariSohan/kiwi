...
<form onSubmit={form.onSubmit((values) => onSubmit(values))}>
    ...
    <TextInput label="Username" placeholder="your name" required {...form.getInputProps('username')}/>
    <TextInput label="Email" placeholder="you@gmail.com" required mt="md" {...form.getInputProps('email')}/>
